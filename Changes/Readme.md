...
|custom|Azure Database for MySQL server deploy a specific min TLS version and enforce SSL. Use in combination with above policy set to audit. |DeployIfNotExists, disabled.|[MySQL_TlsVerson_Deploy.json](../esPoliciesDefinitionsCustom/MySQL_TlsVerson_Deploy.json) | [![Deploy to Azure](https://docs.microsoft.com/en-us/azure/governance/policy/media/deploy/deploybutton.png)](https://portal.azure.com/?#blade/Microsoft_Azure_Policy/CreatePolicyDefinitionBlade/uri/https%3A%2F%2Fraw.githubusercontent.com%2FMathieuRietman%2Fes-Policies%2Fmain%2FesPoliciesDefinitionsCustom%2FMySQL_TlsVerson_Deploy.json)|
...
|custom|PostgreSQL TLS version and enforce SSL connection. Use in combination with above policy set to audit. |DeployIfNotExists, Disabled.|[PostgreSQL_TlsVerson_Deploy.json](../esPoliciesDefinitionsCustom/PostgreSQL_TlsVerson_Deploy.json) | [![Deploy to Azure](https://docs.microsoft.com/en-us/azure/governance/policy/media/deploy/deploybutton.png)](https://portal.azure.com/?#blade/Microsoft_Azure_Policy/CreatePolicyDefinitionBlade/uri/https%3A%2F%2Fraw.githubusercontent.com%2FMathieuRietman%2Fes-Policies%2Fmain%2FesPoliciesDefinitionsCustom%2FPostgreSQL_TlsVerson_Deploy.json)|
...
|custom|Azure Cache for Redis Append a the enforcement that enableNonSslPort is disabled. Deploy if not exists has timing issue and fail.|Append, disabled.|[RedisCache_disableNonSslPort_Append.json](../esPoliciesDefinitionsCustom/RedisCache_disableNonSslPort_Append.json) | [![Deploy to Azure](https://docs.microsoft.com/en-us/azure/governance/policy/media/deploy/deploybutton.png)](https://portal.azure.com/?#blade/Microsoft_Azure_Policy/CreatePolicyDefinitionBlade/uri/https%3A%2F%2Fraw.githubusercontent.com%2FMathieuRietman%2Fes-Policies%2Fmain%2FesPoliciesDefinitionsCustom%2FRedisCache_disableNonSslPort_Append.json)|
|custom|Azure Cache for Redis Append a specific min TLS version requirement and enforce TLS. Deploy if not exists has timing issue and fail.|Append, disabled.|[RedisCache_TlsVerson_Append.json](../esPoliciesDefinitionsCustom/RedisCache_RedisCache_TlsVerson_Append.json) | [![Deploy to Azure](https://docs.microsoft.com/en-us/azure/governance/policy/media/deploy/deploybutton.png)](https://portal.azure.com/?#blade/Microsoft_Azure_Policy/CreatePolicyDefinitionBlade/uri/https%3A%2F%2Fraw.githubusercontent.com%2FMathieuRietman%2Fes-Policies%2Fmain%2FesPoliciesDefinitionsCustom%2FRedisCache_TlsVerson_Append.json)|
...
|custom|SQL Managed Instance deploy a specific min TLS version requirement. Use in combination with above policy set to audit. |DeployIfNotExists, disabled.|[SqlManagedInstance_TlsVerson_Deploy.json](../esPoliciesDefinitionsCustom/SqlManagedInstance_TlsVerson_Deploy.json) | [![Deploy to Azure](https://docs.microsoft.com/en-us/azure/governance/policy/media/deploy/deploybutton.png)](https://portal.azure.com/?#blade/Microsoft_Azure_Policy/CreatePolicyDefinitionBlade/uri/https%3A%2F%2Fraw.githubusercontent.com%2FMathieuRietman%2Fes-Policies%2Fmain%2FesPoliciesDefinitionsCustom%2FSqlManagedInstance_TlsVerson_Deploy.json)|
...
|custom|SQL servers deploy a specific min TLS version requirement. Use in combination with above policy set to audit. |DeployIfNotExists, disabled.|[SqlServer_TlsVerson_Deploy.json](../esPoliciesDefinitionsCustom/SqlServer_TlsVerson_Deploy.json) | [![Deploy to Azure](https://docs.microsoft.com/en-us/azure/governance/policy/media/deploy/deploybutton.png)](https://portal.azure.com/?#blade/Microsoft_Azure_Policy/CreatePolicyDefinitionBlade/uri/https%3A%2F%2Fraw.githubusercontent.com%2FMathieuRietman%2Fes-Policies%2Fmain%2FesPoliciesDefinitionsCustom%2FSqlServer_TlsVerson_Deploy.json)|
...
|custom|Azure Storage deploy a specific min TLS version requirement and enforce SSL/HTTPS. Use in combination with above policy set to audit. |DeployIfNotExists, disabled.|[Storage_TlsVerson_Deploy.json](../esPoliciesDefinitionsCustom/Storage_TlsVerson_Deploy.json) | [![Deploy to Azure](https://docs.microsoft.com/en-us/azure/governance/policy/media/deploy/deploybutton.png)](https://portal.azure.com/?#blade/Microsoft_Azure_Policy/CreatePolicyDefinitionBlade/uri/https%3A%2F%2Fraw.githubusercontent.com%2FMathieuRietman%2Fes-Policies%2Fmain%2FesPoliciesDefinitionsCustom%2FStorage_TlsVerson_Deploy.json)|
<br>
...
<br>
Purpose is to enforce TLS and minumum version.

<br>

Have policies either deny or appand and deploy if not exist. Please note that deny will result in a failed deployment by the Portal. Consider the append and deploy if not exist policies in combination with the audit policy as the deploy if not exist will not result in a compliance result, append will but append works also as a deny if wrong setting is in ARM deployment request.
The deploy if not exist will require time to become compliant as these are on the resource provider itself. These policies may report none compliant for a period of time, but eventually become not applicable because of the policy rule make them not applicable.
...
|Azure Database for MySQL server deploy a specific min TLS version and enforce SSL.  |DeployIfNotExists, disabled.|DeployIfNotExists |[MySQL_TlsVerson_Deploy.json](../esPoliciesDefinitionsCustom/MySQL_minTlsVerson.json) | 
...
|PostgreSQL TLS version and enforce SSL connection. Use in combination with above policy set to audit. |DeployIfNotExists, Disabled.|DeployIfNotExists|[PostgreSQL_TlsVerson_Deploy.json](../esPoliciesDefinitionsCustom/PostgreSQL_minTlsVerson.json) |
...
|Azure Cache for Redis Append a specific min TLS version requirement and enforce TLS. Deploy if not exists has timing issue and fail.|Append, disabled.|Append| [RedisCache_TlsVerson_Append.json](../esPoliciesDefinitionsCustom/RedisCache_RedisCache_TlsVerson_Append.json]) | 
...
|SQL Managed Instance deploy a specific min TLS version requirement. Use in combination with above policy set to audit. |DeployIfNotExists, disabled.|DeployIfNotExists|[SqlManagedInstance_TlsVerson_Deploy.json](../esPoliciesDefinitionsCustom/SqlManagedInstance_TlsVerson_Deploy.json]) |
...
|SQL servers deploy a specific min TLS version requirement. Use in combination with above policy set to audit. |DeployIfNotExists, disabled.|DeployIfNotExists|[SqlServer_TlsVerson_Deploy.json](../esPoliciesDefinitionsCustom/SqlServer_TlsVerson_Deploy.json]) |
...
|Azure Storage deploy a specific min TLS version requirement and enforce SSL/HTTPS. Use in combination with above policy set to audit. |DeployIfNotExists, disabled.|DeployIfNotExists|[Storage_TlsVerson_Deploy.json](../esPoliciesDefinitionsCustom/Storage_TlsVerson_Deploy.json]) | 
...
|Azure Stream Analytics jobs should use customer-managed keys to encrypt data| Deny,Audit,Disabled.|Audit|87ba29ef-1ab3-4d82-b763-87fcd4f531f7 | Ensure that storage account are using CMK [see link](https://docs.microsoft.com/en-us/azure/stream-analytics/data-protection)|
