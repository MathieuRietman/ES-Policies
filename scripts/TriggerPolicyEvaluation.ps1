<#
	.SYNOPSIS
        1. triggers a policy evaluation on provided scope
	...
	.EXAMPLE
	   .\TriggerPolicyEvaluation.ps1 -scope "subscriptions/4d035de6-4cb3-4d00-9796-cdbea308da99"
	   
	.LINK

	.Notes
		NAME:      TriggerPolicyEvaluation
